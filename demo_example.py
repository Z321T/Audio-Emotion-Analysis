...
# 全流程测试函数，依次执行 ASR+情感分析 -> EmoLLM 回复生成 -> TTS 合成，并在每个阶段后释放显存资源。
def asr_llm_tts_full_pipeline():
...
def emollm_reply_test():
    # 模拟 ASR 和情绪分析的输入结果
    asr_input = {
        'asr': '我感觉有点孤单，孩子们都不常回来看我了。',
        'emotion': '孤独、失落'
    }
...
def tts_test():
    # 模拟 EmoLLM 生成的回复文本
    emollm_reply_text = "亲爱的，我能理解你的感受。或许你可以试着给孩子们打个电话，听听他们的声音，或者看看窗外的风景，感受一下自然的美好。你觉得怎么样？"
